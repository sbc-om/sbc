...
function canEditBusiness(user: Awaited<ReturnType<typeof getCurrentUser>>, business: Awaited<ReturnType<typeof getBusinessById>>): boolean {
...
export async function POST(
  ...
  try {
    ...
    const next = await updateBusiness(id, { avatarMode });
