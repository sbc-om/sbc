    ...
    <>
      ...
      <div className="pt-4 border-t text-xs text-(--muted-foreground) mb-4" style={{ borderColor: "var(--surface-border)" }}>
        ...
        <div className="mt-2 flex flex-wrap gap-1.5">
          <span className={`inline-flex items-center rounded-full px-2 py-0.5 text-xs font-medium ${product.showInDashboard ? "bg-blue-100 text-blue-700 dark:bg-blue-900/40 dark:text-blue-300" : "bg-gray-100 text-gray-500 dark:bg-gray-800 dark:text-gray-400 line-through"}`}>
            {ar ? "لوحة التحكم" : "Dashboard"}
          </span>
          <span className={`inline-flex items-center rounded-full px-2 py-0.5 text-xs font-medium ${product.showInStore ? "bg-emerald-100 text-emerald-700 dark:bg-emerald-900/40 dark:text-emerald-300" : "bg-gray-100 text-gray-500 dark:bg-gray-800 dark:text-gray-400 line-through"}`}>
            {ar ? "المتجر" : "Store"}
          </span>
        </div>
      </div>
