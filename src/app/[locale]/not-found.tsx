    ...
    <main className="min-h-screen flex items-center" dir={localeDir(locale)}>
      <Container size="md" className="py-16">
        <section className="sbc-card p-8 sm:p-10 text-center">
          <div
            className="mx-auto mb-5 inline-flex items-center rounded-full border px-4 py-1.5 text-sm font-semibold"
            style={{
          ...
          <p className="mx-auto max-w-xl text-sm sm:text-base mb-8" style={{ color: "var(--muted-foreground)" }}>
            {description}
          </p>
